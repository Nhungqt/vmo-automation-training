...
public class VntripPageUI {
    ...
    public static final String RECEIVE_RETURN_DAY = xpath("//p[contains(text(),'JW Marriott Hanoi')]");
    ...
    public static final String DATPHONG_BTN = xpath("//span[text()='Phòng Deluxe, 2 Giường Đôi, Nhìn Ra Thành Phố']/ancestor::div[@class='roomItem__header ']/following-sibling::div[@class='roomItem__body']//div[@class='roomItem__row'][1]//button");
